...
GENERATE_REFERENCE_SCREENSHOTS_OPTION = "--generate-reference-screenshots"
...
def pytest_addoption(parser):
    ...
    parser.addoption(
        GENERATE_REFERENCE_SCREENSHOTS_OPTION,
        action='store_true',
        default=False,
        help='For tests that generate HTML output, generate reference screenshots for the visual regression tests',
    )
...
def compare_screenshots(request):
    ...
    def _compare_screenshots(test_id, url):
        if (request.config.getoption(COMPARE_SCREENSHOTS_OPTION) or
            request.config.getoption(GENERATE_REFERENCE_SCREENSHOTS_OPTION)):
            ...
            if request.config.getoption(GENERATE_REFERENCE_SCREENSHOTS_OPTION):
